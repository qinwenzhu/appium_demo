...
#
# # 首页定位-我-并进行点击
# driver.find_element_by_id("com.xxzb.fenwoo:id/iv_tab").click()
# # # 定位搜索框，输入关键字
# driver.find_element_by_id("com.xxzb.fenwoo:id/et_phone").send_keys("test")
